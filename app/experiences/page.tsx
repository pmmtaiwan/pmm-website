...
export const metadata: Metadata = pageMetadata(
  "Experiences",
  "Productions, recordings, and video windows from Philharmonia Moments Musicaux."
);
...
export default function ExperiencesPage() {
  return (
    <>
      <PageScene
        eyebrow="Experience Us"
        title="Enter the listening space."
        body="Each PMM production is shaped as an artistic world: a program, a place, a pace of arrival, and a reason for listening now."
        image="/images/page-themes/experience-projection-hall.jpg"
      ...
      <Section eyebrow="Pathways" title="Listen to us. Watch us.">
        <div className="grid gap-5 lg:grid-cols-[0.85fr_1.15fr]">
          <article className="border border-white/15 bg-charcoal p-7">
            <p className="font-sans text-xs uppercase tracking-[0.16em] text-brass">Recordings</p>
            <h2 className="mt-4 text-4xl font-normal">Scan to listen</h2>
          ...
          <article className="placeholder-field p-7">
            ...
            <h2 className="mt-4 text-4xl font-normal">Watch selected videos</h2>
            <div className="mt-7 grid gap-5 sm:grid-cols-2">
              {videos.map((video) => (
                <a
                  key={video.href}
